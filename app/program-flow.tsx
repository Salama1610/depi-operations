...
function Badge({ value }: { value: string }) {
  const color = /Block|Ineligible|Needs|Withdrawn|Archived/.test(value)
    ? "red"
        ...
        action === "assessment"
          ...
          : action === "issue_certificate"
            ...
            : action === "post_program_outcome"
              ? "Employment"
              : "",
      status: action === "post_program_outcome" ? "Reported" : "",
      max_score: 100,
      pass_score: 60,
        ...
        <TabsContent value="intake">
          <section className="panel">
            <div className="panel-heading">
              ...
              <button className="primary" onClick={() => open("application")}>
                <Plus size={16} />
                Register applicant
              </button>
            </div>
                    ...
                    <TableRow key={a.id}>
                      ...
                      <TableCell>
                        <div className="detail-actions">
                          {["Submitted", "Screening", "Waitlisted"].includes(
                            a.status,
                          ) && (
                            <button
                              className="small-btn"
                ...
                .map((s: Row) => (
                  <div className="info-box" key={s.id}>
                    ...
                    <button
                      ...
                      onClick={() =>
                        open("complete_session", { session_id: s.id })
                      }
                    >
          ...
          <section className="panel">
            <div className="panel-heading">
              ...
              <div className="detail-actions">
                ...
                <button
                  className="primary"
                  onClick={() => open("assessment_result")}
                >
                  Record result
                </button>
              </div>
          ...
          <div className="report-grid">
            <section className="panel">
              <div className="panel-heading">
                ...
                <button
                  className="primary"
                  onClick={() => open("issue_certificate")}
                >
                  <Plus size={16} />
                  Issue certificate
                </button>
            ...
            <section className="panel">
              <div className="panel-heading">
                ...
                <button
                  className="small-btn"
                  onClick={() => open("post_program_outcome")}
                >
                  <Plus size={16} />
                  Record outcome
                </button>
          ...
          <div className="report-grid">
            <section className="panel">
              <div className="panel-heading">
                ...
                <button
                  className="small-btn"
                  onClick={() => open("withdrawal_decision")}
                >
                  <Plus size={16} />
                  Record decision
                </button>
            ...
            <section className="panel prose">
              ...
              {activeReport ? (
                <>
                  ...
                  <a
                    className="primary"
                    href={`/api/program?format=ministry_csv&definition=${activeReport.id}`}
                  >
                    <Download size={16} />
                    Export current authorized roster
                  </a>
                </>
              ) : (
                <p>
              ...
              <button
                className="small-btn"
                onClick={() => open("report_definition")}
              >
                <ShieldCheck size={16} />
          ...
          <form onSubmit={submit} className="modal-form">
            {modal?.action === "application" && (
              <>
                ...
                {field("preferred_track", "Preferred technical track")}

...
- **Data**: roster import `ROSTER-65847283428B8258` — 5 tracks, 131 groups, 2,887 students (2,887 unique emails), 2,948 source rows, 61 duplicates linked, status Reconciled. Bootstrap admin provisioned; student logins provisioned for the whole roster on 2026-09-21 (2,881 students: email + 14-digit national ID as first password; 6 closed-lifecycle students skipped). Auth users: 2,882 (incl. admin).
